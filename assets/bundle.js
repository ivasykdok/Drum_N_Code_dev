...
/***/ "./src/js/sections/custom-product-may-run.js":
/*!***************************************************!*\
  !*** ./src/js/sections/custom-product-may-run.js ***!
  \***************************************************/
...
var SelectVariant = /*#__PURE__*/function (_HTMLElement) {
  function SelectVariant() {
    ...
    _this.product = JSON.parse(document.getElementById('product-data').textContent);
    _this.userData = {};
  ...
  return (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(SelectVariant, [{
    ...
    key: "formChangeUserData",
    value: function formChangeUserData() {
      var _this3 = this;
      var uniqueId = new Date().getTime();
      var moreData = true;
      this.userDataInputs.forEach(function (input) {
        input.addEventListener('input', function () {
          if (input.value !== '') _this3.userData["".concat(input.id)] = input.value;else delete _this3.userData["".concat(input.id)];
          _this3.userData._uniqueId = uniqueId;
          _this3.userData._moreData = moreData;
          _this3.formValidate();
        });
      });
    }
    ...
    value: function formValidate() {
      var _this4 = this;
      this.userDataInputs.forEach(function (input) {
        if (_this4.userFormTrigger.checked) {
          if (input.value === '') input.classList.add('error');else input.classList.remove('error');
        }
        if (Object.keys(_this4.userData).length === _this4.userDataInputs.length + 2) {
          _this4.addToCartTriger.disabled = false;
          _this4.checkoutTriger.disabled = false;
          _this4.changeVariant();
        }
      });
    }
  }, {
    key: "resetUserData",
    value: function resetUserData() {
      this.userDataInputs.forEach(function (input) {
        return input.value = '';
      });
      this.userData = {};
    ...
    value: function userDataFormShow() {
      ...
      this.userFormTrigger.addEventListener('change', function () {
        if (_this5.userFormTrigger.checked) {
          _this5.addToCartTriger.disabled = true;
          _this5.checkoutTriger.disabled = true;
          _this5.userDataform.classList.add('show');
        } else {
          _this5.userDataform.classList.remove('show');
          _this5.resetUserData();
          _this5.formChangeUserData();
          _this5.changeVariant();
        }
        _this5.formValidate();
      });
    }
    ...
    value: function initVariantSelect(variantId) {
      ...
      selects.forEach(function (select) {
        ...
        select.dispatchEvent(_this6.change);
      });
    ...
    value: function changeVariant() {
      ...
      var handleChange = function handleChange() {
        ...
        active_variant = _this7.product.variants.find(function (variant, index) {
          return variant.title === title;
        });
        if (active_variant) {
          _this7.changeURL(active_variant.id);
          _this7.initActiveVariantImage(active_variant.id);
          _this7.changeVariantPrice(active_variant.id);
          _this7.readUrl();
          _this7.variantAvailable(active_variant);
        }
      };
      handleChange();
      selects.forEach(function (select) {
        ...
        this.addToCartTriger.addEventListener('click', /*#__PURE__*/(0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_8___default().mark(function _callee2() {
          ...
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_8___default().wrap(function (_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                _this8.addToCartTriger.disabled = true;
                _this8.checkoutTriger.disabled = true;
                _context2.next = 1;
                return _this8.addToCart(_this8.active_variant_id);
              case 1:
                product_added = _context2.sent;
                if (product_added) {
                  _this8.addToCartTriger.disabled = false;
                  _this8.checkoutTriger.disabled = false;
                }
              case 2:
              case "end":
          ...
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 1:
              ...
              data = {
                id: variantId,
                quantity: 1,
                properties: userDataEnable.length > 0 ? _objectSpread({}, userData) : {}
              };
              options = {
                method: 'POST',
                headers: {
...
/*!************************!*\
  ...
  \************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _js_sections_custom_product_may_run__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/js/sections/custom-product-may-run */ "./src/js/sections/custom-product-may-run.js");
